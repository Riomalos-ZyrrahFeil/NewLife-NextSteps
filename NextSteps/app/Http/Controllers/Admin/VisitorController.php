...
class VisitorController extends Controller
{
    ...
    {
        // Fetch follow-up stages for dynamic calculation
        ...
        $sort = $request->get('sort', 'unassigned');
        if ($sort === 'unassigned') {
            $query->orderByRaw('tbl_task_assignment.user_id IS NOT NULL ASC');
        } else {
            $query->orderByRaw('tbl_task_assignment.user_id IS NULL ASC');
        }
